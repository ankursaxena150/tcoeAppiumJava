...
public interface IReq extends DDDD.IBaseFieldExMail {
  // Methods:
  /**
   * <p>
  ...
  @VTID(42)
  void removeCoverage(
          @MarshalAs(NativeType.VARIANT) Object vTest,
  ...
  @VTID(53)
  DDDD.IList getCoverListByFilter(
          String testFilter,
          @Optional @DefaultValue("0") boolean recursive);
