...
public interface ITDConnection4 extends ITDConnection3 {
  ...
  Com4jObject getFavoriteFolderFactory(
          boolean isPublic,
          String module);
  ...
  @VTID(117)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject getFavoriteFactory(
          boolean isPublic,
          String module);
  ...
  @VTID(118)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject getRootsFavoriteFolderFactory(
          boolean isPublic,
          String module);
  ...
  @VTID(119)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject getRootsFavoriteFactory(
          boolean isPublic,
          String module);
  ...
  @VTID(120)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject libraryFolderFactory();
  ...
  @VTID(127)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject rootsAnalysisItemFolderFactory();
  ...
  @VTID(128)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject rootsAnalysisItemFactory();
  ...
  @VTID(130)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject qcResourceFolderFactory();
  ...
  @VTID(131)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject dashboardFolderFactory();
  ...
  @VTID(132)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject dashboardPageFactory();
  ...
  @VTID(133)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject rootsDashboardFolderFactory();
  ...
  @VTID(134)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject rootsDashboardPageFactory();
  ...
  @VTID(136)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject comparisonNodeFactory();
  ...
  @VTID(139)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject assetRepositoryItemFactory();
  ...
  @VTID(145)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject dashboardPageItemFactory();
  ...
  Object getAllVisibleProjectDescriptors(
          int index);
  ...
  @VTID(148)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject excelReportManager();
