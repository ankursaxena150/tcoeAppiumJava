...
public interface ITDConnection2 extends ITDConnection {
  ...
  @VTID(86)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject auditRecordFactory();
  ...
  @VTID(87)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject auditPropertyFactory();
