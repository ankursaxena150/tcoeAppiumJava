...
public interface ITextParser extends Com4jObject {
  ...
  @VTID(8)
  String paramValue(
          @MarshalAs(NativeType.VARIANT) Object vParam);
  ...
  @VTID(15)
  void initialize(
          @Optional @DefaultValue("<%") String startClose,
          @Optional @DefaultValue("%>") String endClose,
          @Optional @DefaultValue("?") String typeClose,
          @Optional @DefaultValue("-1") int maxLen,
          @Optional @DefaultValue("string") String defaultType);
