...
public interface IExecutionSettings extends Com4jObject {
  ...
  void plannedExecutionTime(
          @MarshalAs(NativeType.VARIANT) Object vVal);
  ...
  Com4jObject onExecEventSchedulerActionParams(
          int eventType);
