...
public interface ILibrary extends DDDD.IBaseFieldExMail {
  // Methods:
  /**
   * <p>
  ...
  @VTID(31)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject libraryPartFactory();
   ...
   * </p>
   * @param srcLibrary Mandatory DDDD.ILibraryInfo parameter.
   * @param srcBaselineId Mandatory int parameter.
   * @param comparisonId Mandatory int parameter.
   * @param fieldsToSync Mandatory DDDD.IList parameter.
   * @return  Returns a value of type int
   */
  ...
  @VTID(35)
  DDDD.ILibraryOperationResult createBaselineVerification();
  ...
  @VTID(36)
  DDDD.ILibraryOperationResult syncLibrariesVerification(
          DDDD.ILibraryInfo srcLibrary,
          int srcBaselineId,
          int comparisonId);
  ...
  @VTID(38)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject contentPartFactory();
