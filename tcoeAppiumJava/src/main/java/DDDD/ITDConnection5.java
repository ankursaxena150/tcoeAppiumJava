...
public interface ITDConnection5 extends ITDConnection4 {
  // Methods:
  /**
   * <p>
  ...
  @VTID(150)
  String applicativeSessionCookie();
  ...
  Com4jObject bpModelPathFactory();
  ...
  @VTID(152)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject bpModelFolderFactory();
  ...
  @VTID(154)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject bpModelElementFactory();
  ...
  @VTID(156)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject deletedAssetInfoFactory();
  ...
  @VTID(160)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject kpiDefinitionFactory();
  ...
  @VTID(164)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject runCriterionFactory();
  ...
  @VTID(166)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject thresholdValueFactory();
  ...
  @VTID(169)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject bpIterationFactory();
  ...
  @VTID(170)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject componentParamFactory();
  ...
  @VTID(172)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject bpIterationParamFactory();
  ...
  @VTID(175)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject publicEntityKeyFactory();
  ...
  @VTID(179)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject milestoneScopeItemFactory();
  ...
  @VTID(180)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject kpiMilestoneScopeItemFactory();
  ...
  @VTID(182)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject getCommonFavoriteFolderFactory();
  ...
  @VTID(183)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject getCommonFavoriteFactory();
  ...
  @VTID(184)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject runIterationFactory();
  ...
  @VTID(189)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject reportUserTemplateFactory();
   ...
   * </p>
   * @return  Returns a value of type DDDD.IProjectDescriptor
   */

  @DISPID(189) //= 0xbd. The runtime will prefer the VTID if present
  @VTID(194)
  DDDD.IProjectDescriptor connectedProjectDescriptor();
  ...
  @VTID(195)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject reportToReportProjectTemplateLinkFactory();
  ...
  @VTID(197)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject componentStepFactory();
