...
public interface IReportManager extends Com4jObject {
  ...
  @VTID(12)
  String downloadReportProjectTemplateFile(
          int tmpltID);
  ...
  @VTID(13)
  String downloadReportUserTemplateFile(
          int tmpltID);
   ...
   * @param pFields Mandatory DDDD.IList parameter.
  ...
  Com4jObject createReportUserTemplate(
          String fileName,
          IList pFields,
          String tmplType,
          int owningReportID,
  ...
  @VTID(16)
  String downloadTemplateCreator();
