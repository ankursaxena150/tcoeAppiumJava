...
public interface IGraphBuilder extends Com4jObject {
  ...
  Com4jObject createGraphDefinition(
          int module,
          int graphType);
  ...
  @VTID(8)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject buildGraph(
          @MarshalAs(NativeType.Dispatch) Com4jObject pGraphDef);
  ...
  @VTID(9)
  IList buildMultipleGraphs(
          @MarshalAs(NativeType.VARIANT) Object graphDefs);
