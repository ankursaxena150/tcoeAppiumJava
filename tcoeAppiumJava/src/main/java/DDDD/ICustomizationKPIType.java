...
public interface ICustomizationKPIType extends Com4jObject {
  ...
  @VTID(17)
  String numeratorFunctionSumField();
  ...
  @VTID(21)
  String numeratorTransitionField();
  ...
  @VTID(23)
  String numeratorTransitionFieldFromValues();
  ...
  @VTID(25)
  String numeratorTransitionFieldToValues();
  ...
  @VTID(27)
  String numeratorTransitionPeriod();
  ...
  @VTID(29)
  String denominatorFunctionName();
  ...
  @VTID(31)
  String denominatorFunctionSumField();
  ...
  @VTID(35)
  String denominatorTransitionField();
  ...
  @VTID(37)
  String denominatorTransitionFieldFromValues();
  ...
  @VTID(39)
  String denominatorTransitionFieldToValues();
  ...
  @VTID(43)
  String denominatorTransitionPeriod();
   ...
   * </p>
   * @return  Returns a value of type DDDD.ICustomizationBreakdownTypes
   */

  @DISPID(26) //= 0x1a. The runtime will prefer the VTID if present
  @VTID(52)
  DDDD.ICustomizationBreakdownTypes breakdownTypes();
