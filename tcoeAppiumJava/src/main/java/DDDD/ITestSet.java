...
public interface ITestSet extends DDDD.IBaseFieldEx {
  // Methods:
  /**
   * <p>
   * The test set name.
  ...
  @VTID(33)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject execEventNotifyByMailSettings();
  ...
  @VTID(35)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject testDefaultExecutionSettings();
  ...
  @VTID(42)
  void testSetFolder(
          @MarshalAs(NativeType.VARIANT) Object pNode);
