...
public interface ITDConnection3 extends ITDConnection2 {
  ...
  @VTID(104)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject releaseFolderFactory();
  ...
  @VTID(106)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject serviceFolderFactory();
  ...
  @VTID(107)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject serviceGroupFactory();
  ...
  @VTID(108)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject serviceChangeFactory();
  ...
  @VTID(109)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject applicationEntityTreeManager();
  ...
  @VTID(110)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject applicationEntityFactory();
  ...
  @VTID(112)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject changeEntityTreeManager();
  ...
  @VTID(113)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject changeEntityFactory();
  ...
  @VTID(114)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject applicationConfigurationFactory();
