...
public interface ICustomization4 extends ICustomization3 {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type DDDD.ICustomizationEntityAttributes
   */

  @DISPID(22) //= 0x16. The runtime will prefer the VTID if present
  @VTID(28)
  DDDD.ICustomizationEntityAttributes entityAttributes();
   ...
   * </p>
   * @return  Returns a value of type DDDD.ICustomizationRelations
   */

  @DISPID(23) //= 0x17. The runtime will prefer the VTID if present
  @VTID(29)
  DDDD.ICustomizationRelations relations();
  ...
  Object supportsMultivalueEntitiesTables(
          int index);
  ...
  @VTID(32)
  @ReturnValue(type=NativeType.VARIANT,defaultPropertyThrough={IList.class})
  Object supportsQPMKPITypesEntitiesTables(
          int index);
  ...
  @VTID(33)
  @ReturnValue(type=NativeType.VARIANT,defaultPropertyThrough={IList.class})
  Object supportsHistoryEntitiesTables(
          int index);
  ...
  @VTID(34)
  @ReturnValue(type=NativeType.VARIANT,defaultPropertyThrough={IList.class})
  Object supportWorkflowEntitiesTables(
          int index);
  ...
  @VTID(35)
  @ReturnValue(type=NativeType.Dispatch)
  Com4jObject reportProjectTemplates();
   ...
   * </p>
   * @return  Returns a value of type DDDD.ICustomizationUser
   */

  @DISPID(31) //= 0x1f. The runtime will prefer the VTID if present
  @VTID(37)
  DDDD.ICustomizationUser loggedInUser();
  ...
  @VTID(38)
  @ReturnValue(type=NativeType.VARIANT,defaultPropertyThrough={IList.class})
  Object supportsDataHidingFilterEntitiesTables(
          int index);
